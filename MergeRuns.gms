...
* Overall sets
  ...
  Indicators SATIM indicators /Activity, Capacity, NewCapacity, CapFac, FlowIn, FlowOut, AnnInvCost, FOM, VOM, FuelCosts, Marginals, Levies, ExternalityCosts, CO2Tax, CO2, CO2C, CH4, N2O, CF4, C2F6, CO2eq, FlowInMt, Investment,Price, GVA, Population, Consumption, Employment-rn, Employment-rp, Employment-rs, Employment-rt, Employment-un, Employment-up,Employment-us,Employment-ut, PalmaRatio,20-20Ratio,TradeDeficit,Imports,Exports,pkm, tkm/
  Sector
  SubSector
